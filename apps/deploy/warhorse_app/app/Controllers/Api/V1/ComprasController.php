...
final class ComprasController extends BaseController
{
    public function index(): ResponseInterface
    {
        ...
        if ($estado !== null && ! in_array($estado, ['Solicitado', 'En aprobación', 'En pago', 'En recolección', 'Más información', 'Cancelado', 'Rechazado', 'Instalado', 'Cotizado', 'Comprado'], true)) {
    ...
    public function estado(int $id): ResponseInterface
    {
        ...
        if (! $this->validateData($cambio, [
            'estado'         => 'required|in_list[Solicitado,En aprobación,En pago,En recolección,Más información,Cancelado,Rechazado,Instalado,Cotizado,Comprado]',
