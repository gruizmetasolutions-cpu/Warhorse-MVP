...
export type Urgencia = 'Bajo' | 'Medio' | 'Crítico' | 'Inmediato'
export type EstadoRequisicion = 'Solicitado' | 'En aprobación' | 'En pago' | 'En recolección' | 'Más información' | 'Cancelado' | 'Rechazado' | 'Instalado' | 'Cotizado' | 'Comprado' | 'En trayecto' | 'Bajo pedido'
